...
| **Загрузка на устройстве** | **работает** — Android 14, `BOOT_COMPLETED`, графика, adb, геймпад, мышь по USB |
| Расширение `userdata` на всю карту | работает: две загрузки, 960 МБ → 53 ГБ |
| Экран | 1280×720, плотность 213, `ORIENTATION_90` |
| Доводка | мастер настройки, звук, Wi-Fi, эмуляторы — впереди |
