...
| Дерево исходников развёрнуто | в работе |
| Свой продукт сборки `gammaos_rg52mini` | не начато |
| Первая сборка `system.img` | не начато |
| Сборка образа SD-карты | не начато |
| Загрузка на устройстве | не начато |
...
Для RG52 Mini нужен отдельный продукт — см.
[doc/rg52mini/02-план.md](doc/rg52mini/02-план.md), раздел «Свой продукт».
