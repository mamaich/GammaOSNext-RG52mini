...
| Первая сборка `system.img` | прошла, 3 ч 24 мин, разметка и содержимое проверены |
| Сборка образа SD-карты | прошла, 5.09 ГБ, все проверки чистые |
| Пересборка с `KEEP_VNDK=true` | в работе — без неё vendor-HAL-ы не слинкуются |
